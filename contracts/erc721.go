...
func (_Token *TokenTransactor) CreateToken(opts *bind.TransactOpts, tokenURI string) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "createToken", tokenURI)
}

// CreateToken is a paid mutator transaction binding the contract method 0x45576f94.
//
// Solidity: function createToken(string tokenURI) returns(uint256)
func (_Token *TokenSession) CreateToken(tokenURI string) (*types.Transaction, error) {
	return _Token.Contract.CreateToken(&_Token.TransactOpts, tokenURI)
}

// CreateToken is a paid mutator transaction binding the contract method 0x45576f94.
//
// Solidity: function createToken(string tokenURI) returns(uint256)
func (_Token *TokenTransactorSession) CreateToken(tokenURI string) (*types.Transaction, error) {
	return _Token.Contract.CreateToken(&_Token.TransactOpts, tokenURI)
}
